...
theme.palette = {
  ...
  status: [
    "#bfbfbf", // 0: new, pending
    "#873800", // 1: closed,
    "#faad14", // 2: invoiced, progress, billed, partial received
    "#f5222d", // 3: cancelled, rejected
    "#52c41a", // 4: approved, processed, ordered, transferred, fulfilled confirmed
    "#4482FF", //  5: paid, full received, received
    "#391085", // 6: Uploaded File
    "#a67f59", // 7 :Deleted File,
    "#F75D81" // 8: Requested
  ]
};
